<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <br>
      <!-- <button
        class="fadein-bot fade-500 flex items-center py-2 px-4 mx-auto text-sm font-medium rounded-lg border transition duration-300 md:py-2.5 md:px-5 md:mx-0 text-teal-200 border-teal-200 hover:bg-teal-200 hover:bg-opacity-10 bg-transparent focus:outline-none w-fit"><svg
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-teal-300 pict" :src="require('@/assets/PFP3.png')">
    </div>
  </main>
</template>
